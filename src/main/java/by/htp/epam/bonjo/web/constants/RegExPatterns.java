...
public class RegExPatterns {
	...
	public static final String AD_TITLE = "^[a-zA-Z0-9%-_\\s]{5,45}$";
	public static final String AD_SMALLDESC = "[a-zA-Z0-9,.-_%()\\s]{4,100}";
	public static final String AD_DESCRIPTION = "[a-zA-Z0-9,.-_%()\\s]{4,200}";
	public static final String AD_PRICE = "[0-9]{1,10}";
	
	public static final String CATEGORY_NAME = "^[a-zA-Z0-9_-\\s]{3,40}";
